...
import numpy as np
#Pre-trained model parameters(coefficients and intercept)
...
#Prediction button
prediction_button = ttk.Button(root,text= 'Predict Diabetes', command=perform_prediction)
